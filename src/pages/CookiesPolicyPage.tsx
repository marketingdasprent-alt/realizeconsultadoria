          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                quando os visita. São amplamente utilizados para fazer os websites funcionarem de
            ...
            <section className="mb-8">
              ...
              <h3 className="font-display text-xl font-semibold mb-3 mt-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Permitem que o website se lembre das suas escolhas (como o seu nome de utilizador ou
                preferências de idioma) para proporcionar uma experiência mais personalizada.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                sempre que visitar um site e alguns serviços e funcionalidades poderão não
                funcionar.
              </p>
            </section>
