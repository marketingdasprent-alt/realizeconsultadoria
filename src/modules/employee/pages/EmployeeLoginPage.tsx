  ...
  return (
    <div className="min-h-screen bg-background flex">
              ...
              {forgotPasswordSent ? (
                ...
                >
                  ...
                  <p className="text-muted-foreground mb-6">
                    Verifique a sua caixa de correio em <strong>{forgotPasswordEmail}</strong> para
                    redefinir a senha.
                  </p>
                  <Button
                    variant="outline"
      ...
      <div className="hidden lg:flex flex-1 bg-primary items-center justify-center p-16">
        ...
        >
          <h2 className="text-4xl font-bold text-primary-foreground mb-4">Portal Seguro</h2>
