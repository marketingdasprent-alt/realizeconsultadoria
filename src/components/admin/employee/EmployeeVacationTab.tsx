...
import { Calendar, User, Building2, Loader2 } from "lucide-react";
...
const EmployeeVacationTab = ({ employeeId, employeeName }: EmployeeVacationTabProps) => {
...
export default EmployeeVacationTab;
