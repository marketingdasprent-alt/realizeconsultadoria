...
const SettingsPage = () => {
  ...
  const handleToggleNotification = async (notificationId: string, currentState: boolean) => {
    try {
      ...
      setNotifications(
        notifications.map(n => (n.id === notificationId ? { ...n, is_active: !currentState } : n))
      );
    ...
    <>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">Gerir preferências da conta e do sistema</p>
        </div>
          ...
          <TabsContent value="security">
            <Card className="shadow-card">
              <CardHeader>
                ...
                <CardDescription>Gerir palavra-passe e autenticação</CardDescription>
              </CardHeader>
            ...
            <div className="space-y-6">
              ...
              <Card className="shadow-card">
                <CardHeader>
                  ...
                  <CardDescription>Gerir acessos de administração do sistema</CardDescription>
                </CardHeader>
                <CardContent>
                  {isLoadingAdmins ? (
                      ...
                      <TableBody>
                        {admins.map(admin => (
                          <TableRow key={admin.user_id}>
                            ...
                            <TableCell>
                              {format(new Date(admin.created_at), "d 'de' MMMM 'de' yyyy", {
                                locale: pt,
                              })}
                            </TableCell>
                                  ...
                                  <AlertDialog>
                                    ...
                                    <AlertDialogContent>
                                      <AlertDialogHeader>
                                        ...
                                        <AlertDialogDescription>
                                          Tem a certeza que deseja remover o acesso de administrador
                                          de <strong>{admin.name}</strong>? Esta ação pode ser
                                          revertida convidando o utilizador novamente.
                                        </AlertDialogDescription>
                                      </AlertDialogHeader>
                                      <AlertDialogFooter>
            ...
            <div className="space-y-6">
              ...
              <Card className="shadow-card">
                <CardHeader>
                  ...
                  <CardDescription>Gerir avisos ativos e inativos</CardDescription>
                </CardHeader>
                <CardContent>
                          ...
                          <div className="flex items-start justify-between gap-4">
                            ...
                            <div className="flex items-center gap-2 shrink-0">
                              ...
                              <Button
                                ...
                                size="sm"
                                onClick={() =>
                                  handleToggleNotification(notification.id, notification.is_active)
                                }
                              >
