    ...
    topics: [
      {
        key: 'view',
        label: 'Ver dashboard',
        description: 'Visualizar estatísticas e resumos',
        hasView: true,
        hasExecute: false,
      },
    ],
    ...
    topics: [
      {
        key: 'view',
        label: 'Ver empresas',
        description: 'Visualizar lista de empresas',
        hasView: true,
        hasExecute: false,
      },
      {
        key: 'manage',
        label: 'Gerir empresas',
        description: 'Criar, editar e eliminar empresas',
        hasView: false,
        hasExecute: true,
      },
    ],
    ...
    topics: [
      {
        ...
        description: 'Visualizar lista de colaboradores',
        hasView: true,
        hasExecute: false,
      },
      {
      ...
      },
      {
        ...
        description: 'Modificar dados de colaboradores',
        hasView: false,
        hasExecute: true,
      },
      {
      ...
      },
      {
        key: 'vacation',
        label: 'Gerir férias',
        description: 'Configurar dias de férias',
        hasView: false,
        hasExecute: true,
      },
      {
        key: 'notifications',
        label: 'Enviar avisos',
        description: 'Enviar avisos individuais',
        hasView: false,
        hasExecute: true,
      },
      {
        ...
        description: 'Redefinir passwords de colaboradores',
        hasView: false,
        hasExecute: true,
      },
    ],
    ...
    topics: [
      {
        key: 'view',
        label: 'Ver acessos',
        description: 'Visualizar lista de acessos',
        hasView: true,
        hasExecute: false,
      },
      {
        key: 'manage',
        label: 'Gerir acessos',
        description: 'Criar, editar e eliminar acessos',
        hasView: false,
        hasExecute: true,
      },
      {
        key: 'assignments',
        label: 'Gerir atribuições',
        description: 'Criar, editar e devolver atribuições de equipamentos',
        hasView: true,
        hasExecute: true,
      },
    ],
    ...
    topics: [
      {
        key: 'view',
        label: 'Ver pedidos',
        description: 'Visualizar pedidos de ausência',
        hasView: true,
        hasExecute: false,
      },
      {
        ...
        description: 'Aprovar pedidos total ou parcialmente',
        hasView: false,
        hasExecute: true,
      },
      {
        key: 'reject',
        label: 'Rejeitar pedidos',
        description: 'Rejeitar pedidos de ausência',
        hasView: false,
        hasExecute: true,
      },
    ],
  },
  {
    ...
    topics: [
      ...
      },
      {
        key: 'manage',
        label: 'Gerir tickets',
        description: 'Alterar status e adicionar notas',
        hasView: false,
        hasExecute: true,
      },
    ],
    ...
    topics: [
      {
        key: 'profile',
        label: 'Gerir perfil',
        description: 'Alterar dados do próprio perfil',
        hasView: true,
        hasExecute: true,
      },
      {
        key: 'admins',
        label: 'Gerir administradores',
        description: 'Convidar e remover administradores',
        hasView: true,
        hasExecute: true,
      },
      {
        key: 'groups',
        label: 'Gerir grupos',
        description: 'Criar e editar grupos de acesso',
        hasView: true,
        hasExecute: true,
      },
      {
        key: 'notifications',
        label: 'Gerir avisos',
        description: 'Criar avisos globais',
        hasView: true,
        hasExecute: true,
      },
      {
        key: 'support_subjects',
        label: 'Gerir assuntos suporte',
        description: 'Configurar assuntos de suporte',
        hasView: true,
        hasExecute: true,
      },
    ],
    ...
    topics: [
      {
        key: 'view',
        label: 'Ver jurídico',
        description: 'Visualizar a área jurídica',
        hasView: true,
        hasExecute: false,
      },
      {
        key: 'manage',
        label: 'Gerir jurídico',
        description: 'Criar e editar conteúdo jurídico',
        hasView: false,
        hasExecute: true,
      },
    ],
    ...
    topics: [
      {
        key: 'email',
        label: 'E-mail',
        description: 'Comunicação interna e envio de e-mails',
        hasView: true,
        hasExecute: true,
      },
    ],
