      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-background/70 max-w-md leading-relaxed">
              Especialistas em gestão de recursos humanos e apoio à imigração. Ajudamos empresas e
              colaboradores a realizarem os seus objetivos em Portugal.
            </p>
          </div>
        ...
        <div className="border-t border-background/20 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-background/60 text-sm">NIF: 000000000 | Portugal</p>
          </div>
        </div>
      </div>
    </footer>
