...
import EmployeeVacationTab from '../components/employee/EmployeeVacationTab';
import EmployeeDocumentsTab from '../components/employee/EmployeeDocumentsTab';
import EmployeeAttachmentsTab from '../components/employee/EmployeeAttachmentsTab';
    ...
    <>
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="icon" onClick={() => navigate('/admin/colaboradores')}>
          ...
          <div>
            ...
            {isEditMode && employee?.companies?.name && (
              <p className="text-muted-foreground mt-1">{employee.companies.name}</p>
            )}
          </div>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="w-full justify-start overflow-x-auto">
            ...
            {isEditMode && canVacation && <TabsTrigger value="ferias">Férias</TabsTrigger>}
            {isEditMode && canEdit && (
              <>
